...
INSERT INTO `settings` VALUES (1,'brand_name','موبارو','2026-07-09 10:13:59','2026-07-09 14:29:18'),(2,'brand_phone','۰۳۱-۳۶۶۶۲۱۲۲','2026-07-09 10:13:59','2026-07-09 14:29:18'),(3,'brand_address','تهران، خیابان ولیعصر، پلاک ۱۲۸','2026-07-09 10:13:59','2026-07-09 14:29:18'),(4,'brand_hours','شنبه تا پنجشنبه ۹ صبح - ۸ شب','2026-07-09 10:13:59','2026-07-09 14:29:18'),(5,'brand_email','info@mobaro.ir','2026-07-09 10:13:59','2026-07-09 14:29:18'),(6,'brand_instagram','#','2026-07-09 10:13:59','2026-07-09 14:29:18'),(7,'brand_telegram','#','2026-07-09 10:13:59','2026-07-09 14:29:18'),(8,'brand_linkedin','#','2026-07-09 10:13:59','2026-07-09 14:29:18'),(9,'color_primary','#e11d48','2026-07-09 10:13:59','2026-07-09 14:29:18'),(10,'color_primary_dark','#be185d','2026-07-09 10:13:59','2026-07-09 14:29:18'),(11,'color_gold','#D4AF37','2026-07-09 10:13:59','2026-07-09 14:29:18'),(12,'hero_title','زیبایی را با ما تجربه کنید','2026-07-09 10:13:59','2026-07-09 15:21:00'),(13,'hero_description','سالن زیبایی موبارو با بهترین آرایشگران و محصولات حرفه‌ای در خدمت شماست. رزرو آنلاین، آموزش‌های رایگان و فروشگاه آنلاین.','2026-07-09 10:13:59','2026-07-09 14:29:18'),(24,'booking_phone','۰۳۱-۳۶۶۶۲۱۲۲','2026-07-10 09:29:58','2026-07-10 09:29:58'),(25,'captcha_enabled_admin','1','2026-07-10 10:45:40','2026-07-10 10:45:40'),(26,'captcha_enabled_booking','1','2026-07-10 10:45:40','2026-07-10 10:45:40'),(27,'captcha_enabled_newsletter','1','2026-07-10 10:45:40','2026-07-10 10:45:40'),(28,'captcha_difficulty','medium','2026-07-10 10:45:40','2026-07-10 10:45:40'),(29,'captcha_question_1','5 + 3','2026-07-10 10:45:40','2026-07-10 10:45:40'),(30,'captcha_question_2','12 - 7','2026-07-10 10:45:40','2026-07-10 10:45:40'),(31,'captcha_question_3','9 + 4','2026-07-10 10:45:40','2026-07-10 10:45:40'),(32,'captcha_question_4','15 - 8','2026-07-10 10:45:40','2026-07-10 10:45:40'),(33,'captcha_question_5','6 + 11','2026-07-10 10:45:40','2026-07-10 10:45:40'),(34,'captcha_question_6','20 - 9','2026-07-10 10:45:40','2026-07-10 10:45:40'),(35,'captcha_question_7','8 + 6','2026-07-10 10:45:40','2026-07-10 10:45:40'),(36,'captcha_question_8','14 - 5','2026-07-10 10:45:40','2026-07-10 10:45:40'),(37,'captcha_question_9','10 + 7','2026-07-10 10:45:40','2026-07-10 10:45:40'),(38,'captcha_question_10','18 - 6','2026-07-10 10:45:40','2026-07-10 10:45:40');
INSERT INTO `settings` (`setting_key`, `setting_value`, `created_at`, `updated_at`) VALUES
('meta_title', 'موبارو | سالن زیبایی حرفه‌ای', NOW(), NOW()),
('meta_description', 'سالن زیبایی موبارو با بهترین آرایشگران و محصولات حرفه‌ای در خدمت شماست.', NOW(), NOW()),
('og_title', 'موبارو | سالن زیبایی حرفه‌ای', NOW(), NOW()),
('og_description', 'سالن زیبایی موبارو با بهترین آرایشگران و محصولات حرفه‌ای در خدمت شماست.', NOW(), NOW()),
('og_image', '', NOW(), NOW()),
('hero_bg_image', 'hero-bg.jpg', NOW(), NOW()),
('hero_model_image', 'hero-model.jpg', NOW(), NOW()),
('privacy_content', '', NOW(), NOW()),
('terms_content', '', NOW(), NOW()),
('footer_description', 'سالن زیبایی و مرکز آرایشی حرفه‌ای با ۱۲ سال سابقه در تهران', NOW(), NOW()),
('about_title', 'درباره ما', NOW(), NOW()),
('about_content', '', NOW(), NOW()),
('about_image', '', NOW(), NOW()),
('about_subtitle', 'سالن زیبایی حرفه‌ای با ۱۲ سال تجربه در تهران', NOW(), NOW()),
('about_stat_years', '۱۲', NOW(), NOW()),
('about_stat_clients', '۱۵۰۰', NOW(), NOW()),
('about_stat_services', '۲۰', NOW(), NOW()),
('blog_sidebar_about', '', NOW(), NOW()),
('blog_service_1_name', 'کراتین تراپی', NOW(), NOW()),
('blog_service_1_price', '۱.۲۹۰', NOW(), NOW()),
('blog_service_2_name', 'رنگساژ بالیاژ', NOW(), NOW()),
('blog_service_2_price', '۹۵۰', NOW(), NOW()),
('blog_service_3_name', 'لایه‌برداری پوست سر', NOW(), NOW()),
('blog_service_3_price', '۴۸۰', NOW(), NOW()),
('academy_instructor_bio', '', NOW(), NOW()),
('hero_customers_text', 'بیش از ۴۲۰ مشتری<br>راضی امروز', NOW(), NOW()),
('terms_updated_at', 'تیر ۱۴۰۵', NOW(), NOW()),
('privacy_updated_at', 'تیر ۱۴۰۵', NOW(), NOW()),
('brand_city', 'تهران', NOW(), NOW()),
('promo_coupon_code', 'MOBARO20', NOW(), NOW());
