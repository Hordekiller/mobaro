    ...
    public function index(): void
    {
        $homeData = Cache::remember('home_data', Config::get('cache.ttl.page', 600), function () {
            return [
                ...
                'hairModels' => Database::fetchAll("SELECT * FROM hair_models WHERE is_active = 1 ORDER BY id DESC LIMIT 8"),
                'products' => Database::fetchAll("SELECT * FROM products WHERE is_active = 1 ORDER BY id DESC LIMIT 10"),
