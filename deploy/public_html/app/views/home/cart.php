    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <?php else : ?>
            <div class="cart-page-layout">
                ...
                <input type="hidden" id="checkout-token" value="<?= e($checkoutToken ?? '') ?>">
...
function checkout() {
    ...
    const ct = document.getElementById('checkout-token')?.value || '';
    if (ct) body += '&checkout_token=' + encodeURIComponent(ct);
