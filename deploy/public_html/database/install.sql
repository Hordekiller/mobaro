-- Mobaro Beauty Salon - Full Installation Schema
-- MySQL 5.7+ / MariaDB 10.3+
-- Includes: core schema + payment_logs + verification_codes + phone_verified
...
-- Blog Posts (must be before blog_comments due to FK)
