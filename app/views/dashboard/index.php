<?php
$title = 'پنل کاربری | ' . ($settings['brand_name'] ?? 'موبارو');
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-8">
            ...
            <div class="bg-white rounded-[20px] p-6 shadow-[0_4px_30px_rgba(183,110,121,0.08)] h-fit lg:sticky lg:top-[100px]">
                <div class="text-center pb-5 border-b border-[#efe5dc]">
                    <div class="relative w-[100px] h-[100px] mx-auto mb-3">
                        <?php if ($user['avatar']) : ?>
                            <img src="/assets/images/<?= e($user['avatar']) ?>?v=<?= e($user['updated_at'] ?? time()) ?>" alt="<?= e($user['name']) ?>" class="w-full h-full rounded-full object-cover border-4 border-[#FDF6F0] shadow-[0_4px_20px_rgba(183,110,121,0.25)]">
                        <?php else : ?>
            ...
            <div class="min-w-0">
                <?php if ($currentTab === 'dashboard') : ?>
                    <?php require_once __DIR__ . '/tabs/dashboard.php'; ?>
                <?php elseif ($currentTab === 'appointments') : ?>
                    <?php require_once __DIR__ . '/tabs/appointments.php'; ?>
                <?php elseif ($currentTab === 'courses') : ?>
                    <?php require_once __DIR__ . '/tabs/courses.php'; ?>
                <?php elseif ($currentTab === 'orders') : ?>
                    <?php require_once __DIR__ . '/tabs/orders.php'; ?>
                <?php elseif ($currentTab === 'wishlist') : ?>
                    <?php require_once __DIR__ . '/tabs/wishlist.php'; ?>
                <?php elseif ($currentTab === 'wallet') : ?>
                    <?php require_once __DIR__ . '/tabs/wallet.php'; ?>
                <?php elseif ($currentTab === 'addresses') : ?>
                    <?php require_once __DIR__ . '/tabs/addresses.php'; ?>
                <?php elseif ($currentTab === 'account') : ?>
                    <?php require_once __DIR__ . '/tabs/account.php'; ?>
                <?php elseif ($currentTab === 'password') : ?>
                    <?php require_once __DIR__ . '/tabs/password.php'; ?>
                <?php elseif ($currentTab === 'reviews') : ?>
                    <?php require_once __DIR__ . '/tabs/reviews.php'; ?>
                <?php elseif ($currentTab === 'blog-comments') : ?>
                    <?php require_once __DIR__ . '/tabs/blog-comments.php'; ?>
                <?php elseif ($currentTab === 'order_detail') : ?>
                    <?php require_once __DIR__ . '/tabs/order_detail.php'; ?>
                <?php endif; ?>
            </div>
        </div>
    </div>
